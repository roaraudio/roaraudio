...
int roar_conv_chans_1ton16 (void * out, void * in, int samples, int to);   // yes
int roar_conv_chans_1to28  (void * out, void * in, int samples);           // yes
int roar_conv_chans_1to216 (void * out, void * in, int samples);           // yes
...
int roar_conv_chans_2to18  (void * out, void * in, int samples);           // yes
int roar_conv_chans_2to116 (void * out, void * in, int samples);           // yes
