...
#define ROAR_OE_STREAM_CHANGE_STATE       ROAR_NOTIFY_EGRP2EVENT(ROAR_NOTIFY_OE_GROUP_STREAMS +   0)
#define ROAR_OE_STREAM_EXEC               ROAR_NOTIFY_EGRP2EVENT(ROAR_NOTIFY_OE_GROUP_STREAMS +   1)
#define ROAR_OE_STREAM_EOF                ROAR_NOTIFY_EGRP2EVENT(ROAR_NOTIFY_OE_GROUP_STREAMS +   2)
